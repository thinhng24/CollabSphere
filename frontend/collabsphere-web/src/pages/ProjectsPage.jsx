...
export default function ProjectsPage() {
  ...
  const handleSubmit = async (projectId, projectName) => {
  ...
  const handleGenerateMilestones = async (project) => {
  ...
  return (
    <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
            ...
            <Grid item xs={12} md={6} lg={4} key={project.id}>
              <Card sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
                ...
                <CardActions>
                  ...
                  <Button size="small" onClick={() => handleOpenMilestones(project)}>
                    Milestones
                  </Button>
                  {project.status === 'Pending' && !project.submittedAt && (
                    <>
                      <Tooltip title="Generate AI Milestones">
                        <IconButton size="small" onClick={() => handleGenerateMilestones(project)}>
                      ...
                      <Tooltip title="Submit for Approval">
                        <IconButton
                          size="small"
                          color="primary"
                          onClick={() => handleSubmit(project.id, project.name)}
                        >
      ...
      {/* Milestones Dialog */}
      <Dialog
        open={openMilestonesDialog}
        onClose={() => setOpenMilestonesDialog(false)}
        maxWidth="md"
        fullWidth
      >
        <DialogTitle>
        ...
        <DialogContent>
          ...
          {milestones.length > 0 ? (
            ...
            <Alert severity="info">
              No milestones yet. Add milestones manually or use AI to generate them.
            </Alert>
          )}
        </DialogContent>
        <DialogActions>
          <Button onClick={() => setOpenMilestonesDialog(false)}>Close</Button>
        </DialogActions>
      </Dialog>
    </Container>
  );
