...
using SubjectService.Application.Services;
using SubjectService.Domain.Entities;
using SubjectService.Infrastructure.Data;
using SubjectService.Infrastructure.Repositories;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "SubjectService API",
        Version = "v1",
        Description = "Subject and Syllabus Management Service for CollabSphere"
    });
...
builder.Services.AddScoped<ISyllabusService, SyllabusServiceImpl>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "SubjectService API V1");
...
using (var scope = app.Services.CreateScope())
{
    try
    {
        var dbContext = scope.ServiceProvider.GetRequiredService<SubjectDbContext>();
...
Console.WriteLine("🚀 SubjectService is running...");
app.Run();
