...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Class and Member Management Service for CollabSphere"
    });
...
// Register services
builder.Services.AddScoped<IClassService, ClassServiceImpl>();
builder.Services.AddScoped<IClassMemberService, ClassMemberServiceImpl>();
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "ClassService API V1");
...
Console.WriteLine("🚀 ClassService is running...");
app.Run();
